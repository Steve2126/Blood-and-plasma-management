...
$message=$_POST['Any message for receiver'];
$status=1;
...
<head>
    ...
    <title>BloodBank & Donor Management System | Become A plasma Donar</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Become a <small>Plasma Donor</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Become a plasma Donor</li>
        </ol>
